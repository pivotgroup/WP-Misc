var oneLine = ( function(){
	...
	var adjustSize = function($container, _changingSize ){
	...
	var init = function( $containers, args ){
		...
		$containers.each( function(){
			...
			var _changingSize = adjustSize( $container, _changingSize );
			$container.on( 'resized-w resized-init', function(e, info){
				_changingSize = adjustSize( $container, _changingSize );
			});
		});
