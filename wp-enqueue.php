...
protected function enqueue_magnific(){
	wp_enqueue_script( 'magnific', $this->getDir( '_inc/magnific/jquery.magnific-popup.min.js'), array( 'jquery' ), false, true );
	wp_enqueue_style( 'magnific', $this->getDir( '_inc/magnific/magnific-popup.css') );
}
